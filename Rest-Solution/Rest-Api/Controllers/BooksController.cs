...
namespace Rest_Api.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Post([FromHeader] string title, [FromHeader] string author)
        {
        ...
        /// </returns>
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromHeader] string title, [FromHeader] string author)
        {
